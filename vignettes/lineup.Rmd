...
Let's focus on genes that have bewteen-tissue correlation > 0.8 in
absolute value, and then look at the correlation, across these genes,
...
table of samples that are potential mix-ups.
...
- Explain the results
- Look for the sample duplicate
- Make some plots of the mix-ups
